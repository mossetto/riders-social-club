...
export const getNearbyMembers = (clubId, lat, lng, radius = 50) => api.get(`/clubs/${clubId}/members/nearby`, { params: { lat, lng, radius } })
export const updateMyLocation = (lat, lng) => api.put('/users/me/location', { lat, lng })
